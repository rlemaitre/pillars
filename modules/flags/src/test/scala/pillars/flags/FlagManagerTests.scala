...
class FlagManagerTests extends CatsEffectSuite:
    ...
    val flag1                      = FeatureFlag(flag"flag1", FeatureFlag.Status.Enabled)
    val flag2                      = FeatureFlag(flag"flag2", FeatureFlag.Status.Disabled)
    val config: FeatureFlagsConfig = FeatureFlagsConfig(flags = List(flag1, flag2))
